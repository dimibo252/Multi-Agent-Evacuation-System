...
class EmergencyAgent(Agent):
    ...
    async def send_emergency_to_bms(self, emergency_type, fire_room=None, earthquake_room=None, security_room=None):
        ...
        if emergency_type == "Fire" and fire_room:
            ...
            print(
                f"EmergencyAgent: Mensagem enviada ao BMSAgent sobre incêndio na sala ({fire_room.row}, {fire_room.col}, Floor {fire_room.floor}).")
            ...
            print(
                f"EmergencyAgent: Mensagem enviada ao BMSAgent sobre terremoto na sala ({earthquake_room.row}, {earthquake_room.col}, Floor {earthquake_room.floor}).")
            ...
            print(
                f"EmergencyAgent: Mensagem enviada ao BMSAgent sobre ameaça de segurança na sala ({security_room.row}, {security_room.col}, Floor {security_room.floor}).")
        else:
